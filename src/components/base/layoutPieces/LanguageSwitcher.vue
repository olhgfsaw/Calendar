<template>
  <div class="relative">
    <button
      type="button"
      class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-200 dark:hover:text-gray-100 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2"
      @click="isOpen = !isOpen"
    >
